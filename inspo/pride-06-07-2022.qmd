...
<span style="color::red"> Explanations </span>
...
```{r}
all_pride <- read_csv("https://raw.githubusercontent.com/hardin47/TidyTuesday/gh-pages/2022-06-07/contribution_data_all_states.csv") %>%
  drop_na(Company) %>%
  group_by(Company) %>%
